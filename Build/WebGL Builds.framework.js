...
function _hasVideos(videoIndex) {
 if (videoIndex) {
  if (videoIndex == -1) {
   return false;
  }
...
function _AVPPlayerAudioTrackCount(playerIndex) {
...
function _AVPPlayerClose(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return;
 }
...
function _AVPPlayerFetchVideoTexture(playerIndex, texture, init) {
 if (!_hasVideos(playerIndex)) {
  return;
 }
...
function _AVPPlayerGetCurrentTime(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return 0;
 }
...
function _AVPPlayerGetDecodedFrameCount(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return 0;
 }
 var vid = _videos[playerIndex].video;
...
function _AVPPlayerGetDuration(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return 0;
 }
...
function _AVPPlayerGetLastError(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return 0;
 }
...
function _AVPPlayerGetNumBufferedTimeRanges(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return 0;
 }
...
function _AVPPlayerGetPlaybackRate(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return 0;
 }
...
function _AVPPlayerGetTimeRangeEnd(playerIndex, rangeIndex) {
 if (!_hasVideos(playerIndex)) {
  return 0;
 }
...
function _AVPPlayerGetTimeRangeStart(playerIndex, rangeIndex) {
 if (!_hasVideos(playerIndex)) {
  return 0;
 }
 if (rangeIndex >= _videos[playerIndex].video.buffered.length) {
...
function _AVPPlayerGetVolume(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return 0;
 }
...
function _AVPPlayerHasAudio(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerHasMetadata(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerHasVideo(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerHeight(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return 0;
 }
...
function _AVPPlayerInsertVideoElement(path, idValues, externalLibrary) {
 if (!path) {
  return false;
 }
...
function _AVPPlayerIsBuffering(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerIsFinished(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerIsLooping(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerIsMuted(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerIsPaused(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerIsPlaybackStalled(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerIsPlaying(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerIsSeeking(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerPause(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return;
 }
...
function _AVPPlayerSetMuted(playerIndex, mute) {
 if (!_hasVideos(playerIndex)) {
  return;
 }
...
function _AVPPlayerPlay(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
...
function _AVPPlayerReady(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
 if (_videos) {
...
function _AVPPlayerSeekToTime(playerIndex, timeSec, fast) {
 if (!_hasVideos(playerIndex)) {
  return;
 }
 var vid = _videos[playerIndex].video;
...
function _AVPPlayerSetAudioTrack(playerIndex, trackIndex) {
 if (!_hasVideos(playerIndex)) {
  return;
 }
 if (_videos[playerIndex].video.audioTracks) {
...
function _AVPPlayerSetLooping(playerIndex, loop) {
 if (!_hasVideos(playerIndex)) {
  return;
 }
...
function _AVPPlayerSetPlaybackRate(playerIndex, rate) {
 if (!_hasVideos(playerIndex)) {
  return;
 }
...
function _AVPPlayerSetVolume(playerIndex, volume) {
 if (!_hasVideos(playerIndex)) {
  return;
 }
...
function _AVPPlayerSupportedDecodedFrameCount(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return false;
 }
 var vid = _videos[playerIndex].video;
...
function _AVPPlayerUpdatePlayerIndex(id) {
 var result = -1;
 if (!_hasVideos()) {
  return result;
 }
...
function _AVPPlayerWidth(playerIndex) {
 if (!_hasVideos(playerIndex)) {
  return 0;
 }
...
var asmLibraryArg = {
 "AVPPlayerAudioTrackCount": _AVPPlayerAudioTrackCount,
 "AVPPlayerClose": _AVPPlayerClose,
 "AVPPlayerFetchVideoTexture": _AVPPlayerFetchVideoTexture,
 "AVPPlayerGetCurrentTime": _AVPPlayerGetCurrentTime,
 "AVPPlayerGetDecodedFrameCount": _AVPPlayerGetDecodedFrameCount,
 "AVPPlayerGetDuration": _AVPPlayerGetDuration,
 "AVPPlayerGetLastError": _AVPPlayerGetLastError,
 "AVPPlayerGetNumBufferedTimeRanges": _AVPPlayerGetNumBufferedTimeRanges,
 "AVPPlayerGetPlaybackRate": _AVPPlayerGetPlaybackRate,
 "AVPPlayerGetTimeRangeEnd": _AVPPlayerGetTimeRangeEnd,
 "AVPPlayerGetTimeRangeStart": _AVPPlayerGetTimeRangeStart,
 "AVPPlayerGetVolume": _AVPPlayerGetVolume,
 "AVPPlayerHasAudio": _AVPPlayerHasAudio,
 "AVPPlayerHasMetadata": _AVPPlayerHasMetadata,
 "AVPPlayerHasVideo": _AVPPlayerHasVideo,
 "AVPPlayerHeight": _AVPPlayerHeight,
 "AVPPlayerInsertVideoElement": _AVPPlayerInsertVideoElement,
 "AVPPlayerIsBuffering": _AVPPlayerIsBuffering,
 "AVPPlayerIsFinished": _AVPPlayerIsFinished,
 "AVPPlayerIsLooping": _AVPPlayerIsLooping,
 "AVPPlayerIsMuted": _AVPPlayerIsMuted,
 "AVPPlayerIsPaused": _AVPPlayerIsPaused,
 "AVPPlayerIsPlaybackStalled": _AVPPlayerIsPlaybackStalled,
 "AVPPlayerIsPlaying": _AVPPlayerIsPlaying,
 "AVPPlayerIsSeeking": _AVPPlayerIsSeeking,
 "AVPPlayerPause": _AVPPlayerPause,
 "AVPPlayerPlay": _AVPPlayerPlay,
 "AVPPlayerReady": _AVPPlayerReady,
 "AVPPlayerSeekToTime": _AVPPlayerSeekToTime,
 "AVPPlayerSetAudioTrack": _AVPPlayerSetAudioTrack,
 "AVPPlayerSetLooping": _AVPPlayerSetLooping,
 "AVPPlayerSetMuted": _AVPPlayerSetMuted,
 "AVPPlayerSetPlaybackRate": _AVPPlayerSetPlaybackRate,
 "AVPPlayerSetVolume": _AVPPlayerSetVolume,
 "AVPPlayerSupportedDecodedFrameCount": _AVPPlayerSupportedDecodedFrameCount,
 "AVPPlayerUpdatePlayerIndex": _AVPPlayerUpdatePlayerIndex,
 "AVPPlayerWidth": _AVPPlayerWidth,
